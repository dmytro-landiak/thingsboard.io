	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: '<p>ThingsBoard supports PostgreSQL or PostgreSQL + Cassandra (Hybrid mode) for telemetry storage. For more details on database options, you can check the <a target="_blank" href="/docs/reference/#sql-vs-nosql-vs-hybrid-database-approach">database approach reference</a>.</p>',
			},
			{
