...
You can find a description of all available resource types in the <DocLink product={props.product} path='user-guide/roles/#permissions-table/' target="_blank">permissions table</DocLink>.
